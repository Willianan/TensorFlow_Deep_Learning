...
@time：2019/1/27 11:06
@Project:TensorFlow_Deeping_learning
@Filename:9-31_seq2seq_stock.py
"""
...
def loadstock(window_size):
	names = ['date','code','Close',
	         'top_price','low_price',
	         'opening_price','bef_price',
	         'floor_price','floor','exchange'
	         'Volume','amount','总市值','流通市值']

	data = pd.read_csv('example_70/600000.csv',names = names,header = None,encoding = "gbk")
